...
#include "BigRampAIController.h"
#include "Kismet/GameplayStatics.h"
#include "BehaviorTree/BlackboardComponent.h"
#include "../SmallRamp/SmallRampCharacter.h"
...
ABigRampAIController::ABigRampAIController()
{
	SetupAIPerception();
}

void ABigRampAIController::BeginPlay()
{
	Super::BeginPlay();
	...
	if (AIPerc != nullptr) {
		...
		AIPerc->OnTargetPerceptionUpdated.AddUniqueDynamic(this, &ABigRampAIController::OnTargetPerceptionUpdatedDelegate);

	}
}

void ABigRampAIController::Tick(float DeltaTime)
{
	Super::Tick(DeltaTime);
}

void ABigRampAIController::SetupBlackboard()
{
	...
	AIBlackboard->SetValueAsBool(TEXT("IsAIEnabled"), false);
}

void ABigRampAIController::OnTargetPerceptionUpdatedDelegate(AActor* Actor, FAIStimulus Stimulus)
{
...
void ABigRampAIController::SetupAIPerception()
{
...
void ABigRampAIController::UpdateSightRadius()
{
...
void ABigRampAIController::UpdateCharacterWeaponAI(float WeaponRange)
{
	if (AIBehaviorTree != nullptr)
	{
		UBlackboardComponent* AIBlackboard = GetBlackboardComponent();
